...
const EmpDetail = () => {
    ...
    return (
        <div class="p-3 mb-2  text-dark" style={{backgroundImage:`url('https://t3.ftcdn.net/jpg/05/76/97/98/360_F_576979827_K4JZoVvx6MvJbt9NnSdTZICJP2E6SFe5.jpg')`,backgroundSize:'cover',backgroundPosition:'center'}}>
        <div>
            {/* <div className="row">
